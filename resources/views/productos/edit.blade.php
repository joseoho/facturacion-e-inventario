            ...
            <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.0001" class="form-control @error('precio_kg_usd') is-invalid @enderror" 
                           id="precio_kg_usd" name="precio_kg_usd" value="{{ old('precio_kg_usd', $producto->precio_kg_usd) }}" required>
                    @error('precio_kg_usd')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.001" class="form-control @error('stock_kg') is-invalid @enderror" 
                           id="stock_kg" name="stock_kg" value="{{ old('stock_kg', $producto->stock_kg) }}" required>
                    @error('stock_kg')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-md-4">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" class="form-control @error('iva_porcentaje') is-invalid @enderror" 
                           id="iva_porcentaje" name="iva_porcentaje" value="{{ old('iva_porcentaje', $producto->iva_porcentaje) }}" required>
